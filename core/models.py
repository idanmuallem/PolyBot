...
@dataclass
class TradeSignal:
    post_prob: float        # final risk-adjusted P(YES): raw -> Wang -> market-blend -> disagreement cap
    ...
    wang_edge: float = 0.0           # post_prob - market_price (post blend+cap)
    ...
    disagreement_capped: bool = False  # True if post_prob still disagreed with the
